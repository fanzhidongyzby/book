...
INSERT INTO `association` VALUES ('1',0.6,'10','6'),('2',0.7,'10','7'),('3',0.8,'10','8'),('4',0.9,'10','9');
...
CREATE TABLE `book` (
  ...
  `percent` double NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_kfb1k27rsxco0bd8me1s2kdpq` (`count`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-04-09 11:09:54
